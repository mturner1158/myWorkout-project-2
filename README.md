...
|User 1|See confirmation of their workout submission|Upon clickign the 'subimt your workout' button, a success message should appear and an error pop up if you have not added any exercises|
...
|User 2|See previously submitted workouts|Using the My Workouts apge, a user can see previous workouts|
...
### HTML
Using the [HTML Validator](https://validator.w3.org/), I received no errors for index.html and one warning in myworkouts.html. This warning is due to headings not being a correct heirachy but this code is generated by javascript.
